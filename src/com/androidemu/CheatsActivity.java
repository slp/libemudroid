...
public class CheatsActivity extends ListActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		adapter = new ArrayAdapter<Cheats.Item>(this,
				android.R.layout.simple_list_item_multiple_choice, cheats.getAll());
			...
			case DIALOG_EDIT_CHEAT:
				DialogInterface.OnClickListener l = new DialogInterface.OnClickListener()
				{
					public void onClick(DialogInterface dialog, int which)
					{
						...
						String name = ((TextView) d.findViewById(R.id.cheat_name))
								.getText().toString();
						...
						{
							String code = ((TextView) d.findViewById(R.id.cheat_code))
									.getText().toString().toUpperCase();
							addCheat(code, name);
						}
					}
				};
				return new AlertDialog.Builder(this).setTitle(R.string.new_cheat)
