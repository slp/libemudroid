...
public class FileChooser extends ListActivity implements FileFilter,
		View.OnClickListener, View.OnKeyListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		File dir = null;
		if (path != null) dir = getDirectoryFromFile(path);
		if (dir == null) dir = sdcardDir;
		changeTo(dir);
	}
	...
	public boolean onKey(View v, int keyCode, KeyEvent event)
	{
		if (keyCode == KeyEvent.KEYCODE_ENTER)
		{
			...
			if (name.length() > 0)
			{
				...
				{
					Toast.makeText(this, R.string.invalid_dir, Toast.LENGTH_SHORT).show();
				}
				return true;
			}
		}
	...
	public void onClick(View v)
	{
		...
		else if (v.getId() == R.id.goto_parent)
		{
			...
			if (parent != null) changeTo(parent);
		}
	}
